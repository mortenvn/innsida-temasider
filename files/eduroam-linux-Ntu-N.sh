...
function setup_environment {
  ...
  URL="https://innsida.ntnu.no/web/guest/wiki/-/wiki/Norsk/Orakeltjenesten"
  SUPPORT="orakel@ntnu.no"
if [ ! -z "$DISPLAY" ] ; then
...
if ! ask "This installer will only work properly if you are a member of ${bf}Norges teknisk-naturvitenskapelige universitet - NTNU.${n}" "Continue" 1 ; then exit; fi
